<script>
	...
	onMount(() => {
		...
		tl.add('platMapIn', 0)
			...
			.to(satellite, { opacity: 1, duration: 10 }, 'satelliteFullIn')
			.to(unbuiltParcels, { opacity: 0, duration: 10 }, 'satelliteFullIn')
			.to(cap4, { opacity: 0, duration: 2 }, 'satelliteFullIn')
			.to(cap5, { opacity: 1, duration: 6 }, 'satelliteFullIn')
			...
			.to(cap6, { opacity: 1, duration: 6 }, 'lastBeat')
